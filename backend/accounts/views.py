...
#         if user.exists():
#             return Response(
#                 {"detail": "username already exists"}, status=status.HTTP_226_IM_USED
#             )
...
#         if user.exists():
#             return Response(
#                 {"detail": "eamil already exists"}, status=status.HTTP_226_IM_USED
#             )
...
# #         except:
# #             return Response(
# #                 {"details": "no records found"}, status=status.HTTP_400_BAD_REQUEST
# #             )
# #         t1 = int(time.time())
# #         t2 = obj.time
# #         if (t1 - t2) < 300:
...
# #                 return Response(data, status=status.HTTP_200_OK)
# #             return Response(
# #                 {"details": "wrong otp"}, status=status.HTTP_400_BAD_REQUEST
# #             )
# #         obj.delete()
...
#     def get(self, request):
#         data = {"email": "enter username or email", "password": "enter password"}
#         return Response(data, status=status.HTTP_200_OK)
...
#         else:
#             return Response(
#                 {"details": "no user found"}, status=status.HTTP_400_BAD_REQUEST
#             )
#         user = user[0]
#         if user.check_password(password):
...
#         return Response(
#             {"details": "wrong password"}, status=status.HTTP_400_BAD_REQUEST
#         )


# class ForgotPasswordView(APIView):
#     def get(self, request):
#         data = {"email": "enter email", "password": "enter password"}
#         return Response(data, status=status.HTTP_200_OK)
...
#             else:
#                 return Response(
#                     {"details": "you have not verified your otp for password reset"},
#                     status=status.HTTP_400_BAD_REQUEST,
#                 )
#         else:
#             return Response(
#                 {"details": "we have not got any password reset request"},
#                 status=status.HTTP_400_BAD_REQUEST,
#             )
...
#         except:
#             return Response(
#                 {"details": "please enter valid keyword either self or id of user"}
#             )
#         if user == "self":
...
#             query, many=True, context={"request": request, "user_id": user}
#         )
...
#                 "notification_data": "<b>{}</b> started following you.".format(
#                     user.profile.name
#                 ),
#             }
