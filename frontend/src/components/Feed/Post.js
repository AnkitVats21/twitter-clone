  ...
  return (
    <div className="container">
      <div className="avatar" style={{
        background: "url(https://64.media.tumblr.com/65a196fb655bd10ab4c199bf33146625/94917f4bd6c0bde5-f1/s96x96u_c1/95b4a1942b5229a4ed0544f6492b53f6347c7869.jpg)"
      }}>
      </div>
...
//             />
//             <div className="pointcursor" onClick={() => setModalShow(true)}><RepeatIcon /><span className="peoplecount">{props.rtweet.tweet.retweets}</span></div>
...
//               points={props.likes}
//             />
//             <div className="pointcursor" onClick={() => setModalShow(true)}><RepeatIcon /><span className="peoplecount">{props.retweetcount}</span></div>
//             {/* <div><PublishIcon /><span className="peoplecount">12</span></div> */}
