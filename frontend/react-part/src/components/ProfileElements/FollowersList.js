...
render(){
  ...
  const followlist= this.state.followlist.map(postlist=>{
    return <FollowerCards displayName={postlist.profile.name} id={postlist.profile.id} isfollow={postlist.following} username={postlist.profile.username} avatar={postlist.profile_pic}/>
    })
